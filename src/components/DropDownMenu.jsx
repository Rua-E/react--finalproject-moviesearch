...
return (
  <div>
    <div
          ...
          {isOpen && (
              <div 
              className='px-12  visible sm:invisible rounded-2xl h-fit outline-double outline-yellow-600 outline-8 border-black border-4 border-double bg-yellow-400 pb-auto m-y-20  text-amber-900  text-lg font-bold text-center z-10 min-w-auto translate data-[closed]:translate-y-1 data-[closed]:opacity-0 data-[enter]:duration-200 data-[leave]:duration-150 data-[enter]:ease-out data-[leave]:ease-in' >  
                      <Link to="/">
