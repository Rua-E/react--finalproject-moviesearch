                  ...
                  <div className="flex justify-between w-full h-full">
                    <div className="border-4 border-double border-amber-500 hover:outline-dashed hover:outline-8 hover:outline-orange-800 hover:border-dashed p-5 mb-8 text-xl font-bold text-white w-full flex flex-col items-center align-text-top justify-around text-center h-full">
                      <div>
                        ...
                        <div className="font-thin  text-gray-500">
                          Rating:{" "} <span className='font-extrabold text-white'> 
                          {" "}
                          {movie.Rated} {" "}
                          </span> {" "}
                        </div>
...
//         `https://www.omdbapi.com/?s=${movieTitle}&apikey=3e685048`
//       );
//       setMovies(data);
//       if (data.Response === "True") {
//         setMovies(data.Search);
...
//             Enjoy your Movie!
//           </span> */}
//           <h1 className="relative top-0 w-fit h-auto py-4 justify-center flex bg-gradient-to-r from-orange-800 via-amber-500 to-yellow-300 bg-clip-text text-6xl font-extrabold text-transparent text-center select-auto">
//             Enjoy your Movie!
//           </h1>
//           <select
//             className="w-40 text-center border-amber-400 border-4 rounded-sm bg-gray-500 text-white mb-8"
...
//         <h5 className="text-white bg-black font-thin pb-5 pl-5">
//           {" "}
//           End of search results for:
//           <span className="font-extrabold font-mono pl-3">
//             {" "}
